<?php
/**
 * Title: Seite: Kennenlernen
 * Slug: kids/page-kennenlernen
 * Categories: kids
 * Description: Hero, fünf Anmelde-Schritte und Kontaktformular mit Direktkontakt-Karte.
 * Viewport Width: 1200
 * Inserter: yes
 */
?>
...
<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading">Kennenlernen.</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"is-style-lede"} -->
<p class="is-style-lede">Bevor wir über einen Platz sprechen, lernen wir uns erst einmal kennen. Beim Tag der offenen Tür oder im persönlichen Gespräch. Tragt euch gern in unsere Info-Liste ein, damit wir euch Bescheid geben, sobald der nächste Termin feststeht.</p>
<!-- /wp:paragraph -->
<!-- /wp:kids/hero -->
...
<!-- wp:paragraph -->
<p>Ruft uns an oder schreibt eine Mail. So geht's am schnellsten.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"large"} -->
<p class="has-large-font-size"><a href="tel:+492284787950"><strong>0228&nbsp;478795</strong></a><br><a href="mailto:kita@kids-bonn.de"><strong>kita@kids-bonn.de</strong></a></p>
<!-- /wp:paragraph -->
<!-- /wp:kids/card --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"55%"} -->
<div class="wp-block-column" style="flex-basis:55%"><!-- wp:kids/form-kennenlernen /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- /wp:kids/section -->
