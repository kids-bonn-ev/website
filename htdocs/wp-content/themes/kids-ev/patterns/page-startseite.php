 ...
 * Slug: kids/page-startseite
 * Categories: kids
 * Description: Komplette Startseite — Hero, Störer, Features, Leitbild, Tagesablauf, Elterninitiative, Haus, CTA, Jobs-Teaser, Sponsoren, Kontakt.
 * Viewport Width: 1200
 * Inserter: yes
 */
?>
...
<p class="is-style-eyebrow">Unser Leitbild</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Bewusst handeln.<br>Gemeinsam wachsen.</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph -->
<p>Wir schaffen einen Ort, an dem Kinder sich sicher fühlen, Fragen stellen und wachsen dürfen. Unsere Haltung in sechs Sätzen:</p>
<!-- /wp:paragraph -->
...
<p>KIDS&nbsp;e.V. gehört keinem Träger, keiner Kirche und keiner Firma. Er gehört uns allen. Jede Familie ist Mitglied im Verein, bringt <strong>3&nbsp;bis&nbsp;5&nbsp;Stunden Mitarbeit pro Monat</strong> ein und entscheidet bei den großen Fragen mit.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Das klingt nach viel. Ist es auch. Aber Eltern sagen uns immer wieder: Genau das ist der Grund, warum sich KIDS nicht wie eine Kita anfühlt, sondern wie <em>unsere</em> Kita.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- /wp:kids/section -->
...
<h2 class="wp-block-heading">Unser Haus.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Seit unserem Umzug sind wir in einem <strong>Neubau mitten in Bonn-Beuel</strong> - hell, warm und richtig groß. Drumherum: <strong>1.700&nbsp;m² Garten</strong> zum Toben, Wühlen und Entdecken.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Komm vorbei. Schau dich um.<br>Fühl, ob wir passen.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Lernt uns kennen - beim Tag der offenen Tür oder in einem persönlichen Gespräch. Kein Bewerbungsritual, nur Kaffee, Kekse und ehrliche Fragen.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Erzieher:in mit Haltung? Komm ins Team.</h2>
<!-- /wp:heading -->
