 ...
 * Slug: kids/page-datenschutz
 * Categories: kids
 * Description: Datenschutzerklärung (Template „Schmale Textseite“).
 * Inserter: no
 */
?>
<!-- wp:paragraph -->
<p>Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten") innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unsere Social-Media-Profile (nachfolgend gemeinsam bezeichnet als „Onlineangebot"). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung" oder „Verantwortlicher", verweisen wir auf die Definitionen im Art. 4 der Datenschutz-Grundverordnung (DSGVO).</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>KIDS e.V.<br>Limpericher Str. 122b<br>53225 Bonn</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Telefon: <a href="tel:+492284787950">0228 478795</a><br>E-Mail: <a href="mailto:kita@kids-bonn.de">kita@kids-bonn.de</a><br>Vereinsregister-Nr. des Amtsgerichts Bonn: 4916</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><strong>Vorstand im Sinne des § 26 BGB:</strong><br>Vorsitzende: Sarah Akwah<br>Vorsitzender: Timon Pantelouris<br>Kassenwartin: Rebekka Dierkes</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Arten der verarbeiteten Daten</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Kategorien betroffener Personen</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Zweck der Verarbeitung</h2>
<!-- /wp:heading -->
...
<!-- wp:list-item -->
<li>Abwicklung von Spenden.</li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Verwendete Begrifflichkeiten</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Maßgebliche Rechtsgrundlagen</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Zusammenarbeit mit Auftragsverarbeitern und Dritten</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Übermittlungen in Drittländer</h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p>Nach gesetzlichen Vorgaben in Österreich erfolgt die Aufbewahrung insbesondere für 7 Jahre gemäß § 132 Abs. 1 BAO (Buchhaltungsunterlagen, Belege/Rechnungen, Konten, Belege, Geschäftspapiere, Aufstellung der Einnahmen und Ausgaben, etc.), für 22 Jahre im Zusammenhang mit Grundstücken und für 10 Jahre bei Unterlagen im Zusammenhang mit elektronisch erbrachten Leistungen, Telekommunikations-, Rundfunk- und Fernsehleistungen, die an Nichtunternehmer in EU-Mitgliedstaaten erbracht werden und für die der Mini-One-Stop-Shop (MOSS) in Anspruch genommen wird.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Online-Spenden</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Wenn über die Online-Spenden-Funktion eine Spende entrichtet wird, ist es erforderlich, dass persönliche Daten angegeben werden (z.B. Name, E-Mail-Adresse, IBAN), die wir für die Abwicklung der Spende benötigen. Für die Abwicklung notwendige Pflichtangaben sind gesondert markiert, weitere Angaben sind freiwillig. Die angegebenen Daten verarbeiten wir zur Abwicklung der Spende. Dazu können wir die Zahlungsdaten auch an Dritte (wie bspw. Banken und Payment-Anbieter) weitergeben, soweit dies zur Abwicklung der Spende notwendig ist. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. b DSGVO.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Die E-Mail-Adresse und Postanschrift werden benötigt, damit eine Spendenquittung ausgestellt werden kann.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Gemäß Art. 6 Abs. 1 lit. b) EU-DSGVO speichern wir Deine Daten zur Spendenbearbeitung und gemäß Art. 6 Abs. 1 lit. f) EU-DSGVO (berechtigtes Interesse) zur Spendenakquise.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Hosting und E-Mail-Versand</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Einbindung von Diensten und Inhalten Dritter</h2>
<!-- /wp:heading -->
